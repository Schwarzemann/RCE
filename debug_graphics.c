...
int currentColorScheme = 0; // Track color schemes

// Frame rate variables
float lastTime = 0.0f;
float frameRate = 0.0f;

// Function to cycle color schemes
void switchColorScheme() {
    currentColorScheme = (currentColorScheme + 1) % 3; // Cycle between 3 color schemes
}

void cursorPosCallback(GLFWwindow* window, double xpos, double ypos);
void renderText(float x, float y, const char* text);

// Render the cube with different color schemes
void renderCube() {
    glBegin(GL_QUADS);
    ...
    switch (currentColorScheme) {
        case 0: // Default color scheme
            ...
            // Other faces...
            // (rest of the cube faces use predefined colors)
            break;

        case 1: // Gradient color scheme
            // Front face (gradient red to yellow)
            ...
            // Other faces with gradient colors...
            break;

        case 2: // Cool-toned color scheme
            // Front face (blue to cyan)
...
// Function to handle input, including switching color schemes on Enter press
void handleInput() {
    ...
    // Detect Enter key press to switch color scheme
